...
THREE.VolumeRenderShader1 = {
	...
	fragmentShader: [
		...
		"										emission += (1.0/(2.0*starDepth*starDepth))*texture2D(u_starDiffuse,gl_FragCoord.xy/vec2(u_screenWidth,u_screenHeight)).rgb;",//vec3(1.0-starDepth,1.0-starDepth,0.0);",
